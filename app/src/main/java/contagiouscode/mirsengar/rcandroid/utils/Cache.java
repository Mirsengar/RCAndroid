 ...
 */
public static
void CacheCommuting ( CommutingObject commutingObject ) {
     CommutingObject[]        cache =
               new Gson ( ).fromJson ( Storage.get ( ).getString ( "Cache" , "" ) ,
                                       CommutingObject[].class );
 ...
 */
public static
List < CommutingObject > ReadCachedCommuting ( ) {
     CommutingObject[] cache =
               new Gson ( ).fromJson ( Storage.get ( ).getString ( "Cache" , "" ) ,
                                       CommutingObject[].class );
