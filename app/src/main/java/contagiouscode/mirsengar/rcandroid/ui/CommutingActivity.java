...
public
class CommutingActivity extends BaseActivity {
...
void fetchData ( ) {
     ...
     Call < List < CommutingObject > > call =
               Application.getRetrofit ( ).create ( MzQAPI.class ).GetCommuting ( body );
     call.enqueue ( new Callback < List < CommutingObject > > ( ) {
          @Override
          public
          void onResponse ( Call < List < CommutingObject > > call ,
                            Response < List < CommutingObject > > response ) {
          ...
          @Override
          public
          void onFailure ( Call < List < CommutingObject > > call , Throwable t ) {
...
private
void CacheCommuting ( String type ) {
